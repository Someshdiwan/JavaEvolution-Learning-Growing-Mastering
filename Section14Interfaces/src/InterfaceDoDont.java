interface TestInterfaces{
    static  final int X=10; //Final and static if you dont write also
...
public class InterfaceDoDont
{
    public static void main(String[] args)
    {
        ...
        // We can not create object of Interface but
        // we can access static final member using interface name and dot operator.
        // we can access interfcae objects using interface and dot operator. we cant create object of interface
