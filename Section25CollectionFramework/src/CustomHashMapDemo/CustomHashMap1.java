...
public class CustomHashMap1<K, V> implements Iterable<CustomHashMap1.Entry<K, V>> {
    ...
    public CustomHashMap1(int initialCapacity, double loadFactor) {
    ...
    public static void main(String[] args) {
        CustomHashMap1<Object, Integer> map = new CustomHashMap1<Object, Integer>();
        map.put("Alice", 25);
        map.put("Bob", 30);
        map.put("Charlie", 35);
        ...
        for (Entry<Object, Integer> entry : map) {
